                ...
                <div class="dropdown-body">
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="../assets/images/profile/미모티콘.png" alt="profile image">
      ...
      <div class="sidebar">
        <div class="user-profile">
          <div class="display-avatar animated-avatar">
            <img class="profile-img img-lg rounded-circle" src="../assets/images/profile/미모티콘.png" alt="profile image">
          </div>
          <div class="info-wrapper">
            <p class="user-name"><a href="javascript:minihome()">몽구링</a></p>
            <script type="text/javascript">
           		function minihome(){
           			var op = "width=1000, height=500, left=50, top=150"
           			open("minihome.jsp","",op)
           		}
            </script>
          </div>
        </div>
        <ul class="navigation-menu">
          ...
          <li>
            <a href="#sample-pages" data-toggle="collapse" aria-expanded="false">
              <span class="link-title">스티커</span>
          ...
          <li>
            <a href="pages/icons/material-icons.jsp">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-sm">
                      ...
                      <tbody>
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="../assets/images/profile/미모티콘.png" alt="profile image">
                          </td>
                          <td class="pl-md-0">
