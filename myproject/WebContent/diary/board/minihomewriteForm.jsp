...
<style type="text/css">
  ...
  <body class="header-fixed">
    ...
    <div class="page-body">
      ...
      <!-- 내가만든 리스트 -->
		<form action="minihomewrite.do?boardnum=4" style="width: 95%; height: 100%; margin-left:10px; margin-top: 10px; align-content: center; "
			method="post" enctype="multipart/form-data" name="f">
			<input type="hidden" value="${login}" name="id"> 
			<div class="grid">
				<table style="text-ailgn: center; border-collapse: collapse;"
							class="form-group input-rounded">
					<tr>
						<td>글쓴이</td>
						<td><input size="150" class="form-control" type="text"
							value="${nickname}" name="name" readonly></td>
					</tr>
					<tr>
						<td>제목</td>
						<td><input size="150" class="form-control" type="text"
					...
					<tr>
						...
						<textarea class="form-control" rows="15" cols="20"
								name="content" id="content1"></textarea>
						<script type="text/javascript">
					...
					<tr>
						<td>배경</td>
						<td><input class="form-control" type="text" readonly name="backimg" value="배경지"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" align="center"><input class="btn btn-outline-success btn-rounded" type="button" value="게시물 등록"
							onclick="inputcheck()">
							<a href="minihome.do?id=${mem.id}&boardnum=4">
								<input class="btn btn-outline-success btn-rounded" type="button" value="나가기">
							</a>
						</td>
					</tr>
				</table>
